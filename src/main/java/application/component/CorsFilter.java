...
public class CorsFilter implements Filter {
    ...
    // 跨域地址添加
    private final List<String> allowedOrigins = Arrays.asList("http://42.192.9.46:4200", "http://101.35.175.84:8899",
            "http://101.35.175.84/:8999","http://localhost:8080","http://101.35.175.84:8083","http://localhost:8899","http://localhost:4200");
...
//    private final List<String> allowedOrigins = Arrays.asList("http://localhost:4200", "http://localhost:8899",
//            "http://69.234.193.188:8899","http://localhost:8080","http://69.234.193.188:8080");
